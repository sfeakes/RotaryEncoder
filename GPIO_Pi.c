...
#include "GPIO_Pi.h"
  ...
  //#define LOG_ERROR(fmt, ...) gpio_log_message (true, fmt, ##__VA_ARGS__)
  #define LOG_ERROR(fmt, ...) gpio_log_message (true, "%s: " fmt, _GPIO_pi_NAME_,##__VA_ARGS__)
#else
  #define LOG_ERROR(...) {}
#endif

#ifdef GPIO_LOG_ENABLED
  //#define LOG_ERROR(fmt, ...) gpio_log_message (false, fmt, ##__VA_ARGS__)
  #define LOG(fmt, ...) gpio_log_message (false, "%s: " fmt, _GPIO_pi_NAME_,##__VA_ARGS__)
#else
  #define LOG(...) {}
#endif

#ifdef GPIO_DEBUG
  #define DEBUG(fmt, ...) gpio_log_message (false, "%s: (%s) " fmt, _GPIO_pi_NAME_,"DEBUG",##__VA_ARGS__)
#else
  #define DEBUG(...) {}
#endif
